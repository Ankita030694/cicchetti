  ...
  return (
    <div className="bg-[#3b3f27] relative w-full overflow-x-hidden min-h-screen pb-20">
      ...
      <section className="relative w-full px-6 py-16 flex flex-col gap-12 text-center z-10">
        {/* Intro Text */}
        <p className="text-[22px] leading-[32px] text-white/90" style={{ fontFamily: "Aston, Deluce, sans-serif" }}>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-[38px] leading-[48px] text-[#e7e3e2] uppercase" style={{ fontFamily: "Aston, Deluce, sans-serif" }}>
              Our Concept
            </h2>
            <p className="text-[20px] leading-[30px] text-[rgba(231,227,226,0.7)]" style={{ fontFamily: "Aston, Deluce, sans-serif" }}>
